function anison_init() {
    ...
    var list_320 = "http://s1.radio.ru-hoster.com:8000/AniSonFM(320)";
    anison_start.click(function () {
        anison_player.jPlayer("clearMedia");
        anison_player.jPlayer("setMedia", {mp3: list_320});
        anison_player.jPlayer("play", 0);
    ...
    anison_player.jPlayer({
        ...
        }, swfPath: "http://anison.fm/js/jplayer/Jplayer.swf"
    });
